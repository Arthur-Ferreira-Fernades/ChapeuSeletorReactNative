...
export default function DesempataDsEle({route}) {
    ...
    function calculaPonto(){
        if (selectedRadio1 == 2) {
            ...
            navigation.navigate('DesempataDsLog');
        }
      ...
      <View style = {styles.contentContainer}>
        <View style = {styles.Container}>
            <View style = {styles.texto}>
                <Text style = {styles.pergunta}>Ao pensar em sua futura carreira, você se vê mais:</Text>
                <TouchableOpacity onPress={() => setSelectedRadio1(1)}>
                    <View style = {styles.wrapper}>
                        ...
                        <Text style = {styles.radioText}>
                            a) Desenvolvendo e criando soluções de software.
                        </Text>
                    </View>
                </TouchableOpacity>
                ...
                <Text style = {styles.pergunta}>Quando enfrenta um problema complexo, você prefere lidar com:</Text>
                ...
                <Text style = {styles.pergunta}>Quando se trata de trabalhar em equipe, você se sente mais confortável:</Text>
                <TouchableOpacity onPress={() => setSelectedRadio3(1)}>
                    <View style = {styles.wrapper}>
                        ...
                        <Text style = {styles.radioText}>
                            a) Colaborando no desenvolvimento de novos sistemas e aplicativos.
                        </Text>
                    </View>
                </TouchableOpacity>
